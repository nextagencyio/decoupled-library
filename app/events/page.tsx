...
export const metadata: Metadata = {
  title: 'Events & Activities | Riverside Public Library',
  description: 'Upcoming events at Riverside Public Library including author visits, book sales, workshops, performances, and community activities for all ages.',
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-purple-100 max-w-3xl mx-auto">
              Author visits, book sales, workshops, and community activities for all ages.
            </p>
          </div>
        </div>
      </section>
