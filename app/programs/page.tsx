...
export const metadata: Metadata = {
  title: 'Programs & Classes | Riverside Public Library',
  description: 'Discover free programs for all ages at Riverside Public Library, from baby storytime and teen coding clubs to senior tech help and adult book clubs.',
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-purple-100 max-w-3xl mx-auto">
              Free programs for all ages including storytime, coding clubs, book clubs, and technology classes.
            </p>
          </div>
        </div>
      </section>
