...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Oakwood Public Library. We\'d love to hear from you about library services, programs, or your library account.',
  keywords: ['Contact Oakwood Public Library', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about library services, programs, or your library account? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@oakwoodlibrary.org</p>
                    <p className="text-gray-600">support@oakwoodlibrary.org</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 789-0122</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Monday - Thursday: 9:00 AM - 9:00 PM<br />
