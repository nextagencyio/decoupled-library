...
export const metadata: Metadata = {
  title: 'News & Announcements | Riverside Public Library',
  description: 'Stay up to date with the latest news, announcements, and updates from Riverside Public Library including new collections, hours changes, and community programs.',
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-purple-100 max-w-3xl mx-auto">
              The latest news, announcements, and updates from Riverside Public Library.
            </p>
          </div>
        </div>
      </section>
